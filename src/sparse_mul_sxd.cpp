...
// template dense::matrix<float> sparse::operator*(
//     const sparse::matrix<float>&, const dense::matrix<float>&);
// template dense::matrix<double> sparse::operator*(
//     const sparse::matrix<double>&, const dense::matrix<double>&);
// template dense::matrix<std::complex<float>> sparse::operator*(
//     const sparse::matrix<std::complex<float>>&, const dense::matrix<std::complex<float>>&);
// template dense::matrix<std::complex<double>> sparse::operator*(
